...
(* FIXME *)
(* Lemma repr_roots_repr_lval θ roots m : *)
(*   repr_roots θ roots m -> forall k v, *)
(*   roots !! k = Some v -> exists w, m !! k = Some (Storing w) /\ repr_lval θ v w. *)
(* Proof. *)
(*   induction 1; intros ??. *)
...
Lemma repr_dom_eq θ mem roots_1 roots_2 p1 p2 m1 m2 :
   map dom roots_1 = map dom roots_2
 → gmap_inj θ
