...
(** Language *)
Canonical Structure heap_ectxi_lang p:= EctxiLanguage (ml_toy_lang.ml_toy_lang_mixin p).
Canonical Structure heap_ectx_lang p:= EctxLanguageOfEctxi (heap_ectxi_lang p).
Canonical Structure ml_toy_lang p:= LanguageOfEctx (heap_ectx_lang p).
