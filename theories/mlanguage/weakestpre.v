...
(* TODO: add an "is_value_like" predicate to languages? Currently values have "canonical" NB, other
   expressions should not do so. Proving this is however supposed to be a meta-theorem *)
